...
Simply pulling `lscr.io/linuxserver/plex-meta-manager:develop` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/plex-meta-manager:develop .
```
