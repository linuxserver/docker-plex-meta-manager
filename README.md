...
<!-- Please read the https://github.com/linuxserver/docker-plex-meta-manager/blob/nightly/.github/CONTRIBUTING.md -->
...
Simply pulling `lscr.io/linuxserver/plex-meta-manager:nightly` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
services:
  plex-meta-manager:
    image: lscr.io/linuxserver/plex-meta-manager:nightly
...
docker run -d \
  ...
  --restart unless-stopped \
  lscr.io/linuxserver/plex-meta-manager:nightly
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/plex-meta-manager:nightly`
...
* Update the image: `docker pull lscr.io/linuxserver/plex-meta-manager:nightly`
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/plex-meta-manager:nightly .
```
