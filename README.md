...
<!-- Please read https://github.com/linuxserver/docker-plex-meta-manager/blob/nightly/.github/CONTRIBUTING.md -->
...
* Update the image:
    ...
    ```bash
    docker pull lscr.io/linuxserver/plex-meta-manager:nightly
    ```
